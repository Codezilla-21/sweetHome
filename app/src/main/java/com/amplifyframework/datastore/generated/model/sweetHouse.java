...
public final class sweetHouse implements Model {
  ...
  public static final QueryField USER_ID = field("sweetHouse", "userID");
  ...
  private sweetHouse(String id, String area, String location, String numberOfRooms, String floors, Integer price, String ageOfBuild, Boolean pool, String rentOfSell, List<String> image, Boolean balcony, String moreInfo, String type, String email, String userID) {
    this.id = id;
    this.area = area;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), sweetHouse.getId()) &&
              ...
              ObjectsCompat.equals(getUserId(), sweetHouse.getUserId()) &&
  ...
  public static class Builder implements AreaStep, LocationStep, NumberOfRoomsStep, FloorsStep, PriceStep, AgeOfBuildStep, PoolStep, RentOfSellStep, ImageStep, BalconyStep, TypeStep, EmailStep, UserIdStep, BuildStep {
    private String id;
    private String area;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String area, String location, String numberOfRooms, String floors, Integer price, String ageOfBuild, Boolean pool, String rentOfSell, List<String> image, Boolean balcony, String moreInfo, String type, String email, String userId) {
      super.id(id);
      super.area(area)
        .location(location)
